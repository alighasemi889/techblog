const Footer = () => {
  ...
  const footerLinks = {
    Categories: ['AI', 'Programming', 'Cybersecurity', 'Tutorials'],
    Company: ['About', 'Careers', 'Contact', 'Press'],
    Resources: ['Newsletter', 'Sitemap', 'RSS Feed', 'API'],
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            ...
            <p className="text-slate-400 text-sm mb-6">
              Your source for AI, programming, and cybersecurity knowledge.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <p className="text-center text-slate-500 text-sm">
            Designed & Developed by Ali Ghasemi
          </p>
          <p className="text-center text-slate-600 text-xs mt-2">
            &copy; {currentYear} TechBlog. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
